...
import com.example.murat.benimbebegim.model.Alarm;
import com.example.murat.benimbebegim.model.AlarmMsg;
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (!TextUtils.isEmpty(msgEdit.getText())) {
                                    ...
                                    Toast.makeText(ActivityAlarm.this, "Enter a message", Toast.LENGTH_SHORT).show();
                                }
                            }
                        })
